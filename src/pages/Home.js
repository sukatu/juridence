...
const Home = () => {
  ...
  return (
    <div className="content-stretch flex flex-col items-start relative size-full">
      {/* Hero Section */}
      <div className="h-[1094px] overflow-clip relative shrink-0 w-full">
      ...
      {/* Header */}
          ...
          {/* Dashboard Preview */}
          <div className="w-full mt-8 flex justify-center overflow-hidden">
            <img 
              src="/previews/dashboard-preview.png" 
              alt="Dashboard Preview" 
              style={{ border: 'none', outline: 'none', display: 'block', height: '500px'}}
            />
          </div>
        </div>
      </div>
      ...
      <div className="bg-[#f7f8fa] h-[1146px] overflow-clip relative shrink-0 w-full">
        <div className="absolute content-stretch flex flex-col gap-[80px] items-center left-[100px] right-[100px] top-[120px]">
          ...
          <div className="content-stretch flex flex-col gap-[40px] items-end relative shrink-0 w-full">
            <div className="content-stretch flex items-center justify-center gap-[8px] relative shrink-0 w-full">
        ...
        <div className="absolute content-stretch flex flex-col gap-[40px] h-[798px] items-start left-[100px] right-[100px] top-[60px]">
          ...
          <div className="content-stretch flex flex-col gap-[40px] items-start relative shrink-0 w-full">
            <div className="content-stretch flex gap-[40px] items-start relative shrink-0 w-full">
              <div className="basis-0 bg-white border-l-2 border-[#3B82F6] border-solid box-border content-stretch flex flex-col gap-[12px] grow items-start min-h-px min-w-px p-[24px] relative rounded-[8px] shrink-0">
          ...
          <div className="relative flex items-start justify-between z-10 w-full">
            ...
            <div className="flex gap-10 items-start">
              ...
              <div className="flex flex-col gap-2 items-start">
                ...
                {/* Background Watermark Logo - positioned at absolute bottom right */}
                <div className="relative bottom-0 right-0 pointer-events-none z-0 flex items-end justify-end">
          <img
