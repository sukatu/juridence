...
const AddSecretaryDrawer = ({ onClose, onSave, initialData = null, isEditMode = false }) => {
  ...
  const [formData, setFormData] = useState({
    ...
    tin: initialData?.tin || '',
    incorporationDate: initialData?.incorporationDate ? formatDateForInput(initialData.incorporationDate) : '',
          ...
          <div className="flex flex-col self-stretch gap-10">
            <div className="flex flex-col self-stretch gap-6">
              ...
              <div className="flex flex-col items-start self-stretch gap-6">
                <span className="text-[#525866] text-xs">{isEditMode ? 'EDIT SECRETARY' : 'ADD NEW SECRETARY'}</span>
              ...
              <div className="flex flex-col self-stretch gap-4">
                ...
                <div className="flex flex-col self-stretch gap-2">
                  <div className="flex justify-between items-start self-stretch">
                    <span className="text-[#040E1B] text-xs font-bold">TIN</span>
                    <img
                      src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/Iq8V0MifpP/v3ktwgle_expires_30_days.png"
                      className="w-4 h-4 object-fill"
                      alt="Optional"
                ...
                <div className="flex flex-col self-stretch gap-2">
                  <div className="flex justify-between items-start self-stretch">
                    <span className="text-[#040E1B] text-xs font-bold">Incorporation Date</span>
                    <img
                      src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/Iq8V0MifpP/v3ktwgle_expires_30_days.png"
                      className="w-4 h-4 object-fill"
                      alt="Optional"
                ...
                <div className="flex flex-col self-stretch gap-2">
                  <div className="flex justify-between items-start self-stretch">
                    <span className="text-[#040E1B] text-xs font-bold">End Date (if past secretary)</span>
                    <img
                      src="https://storage.googleapis.com/tagjs-prod.appspot.com/v1/Iq8V0MifpP/v3ktwgle_expires_30_days.png"
                      className="w-4 h-4 object-fill"
                      alt="Optional"
...
export default AddSecretaryDrawer;
