...
const EditTaskDrawer = ({ isOpen, onClose, task, onSave }) => {
  ...
  useEffect(() => {
    if (task) {
      setFormData({
        title: task.title || '',
        type: task.type || '',
        linkedCase: task.linkedCase || '-',
        priority: task.priority || '',
        dueDate: task.dueDate || '',
        status: task.status || '',
        additionalNote: task.additionalNote || 'Verify that the case status and gazette linkage are accurate before publishing.'
      });
    }
  }, [task]);
  ...
  // Format date for display (convert "Nov 2" to "November 2, 2025")
  const formatDateForInput = (dateStr) => {
    if (!dateStr || dateStr === '-') return '';
    // If it's already in full format, return as is
    if (dateStr.includes('November') || dateStr.includes('2025')) {
      return dateStr;
    }
    // Convert "Nov 2" to "November 2, 2025"
    const monthMap = {
        ...
        <div className="p-10 flex flex-col gap-4">
          ...
          <div className="flex flex-col gap-10">
            <div className="flex flex-col gap-6">
              {/* Header */}
              <div className="flex flex-col gap-6">
                <span className="text-[#525866] text-xs opacity-75">EDIT TASK</span>
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <input
                    ...
                    className="w-full px-4 py-4 bg-[#F7F8FA] rounded-lg text-[#050F1C] text-sm font-normal outline-none focus:ring-2 focus:ring-[#022658]"
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col gap-2 relative">
                  ...
                  <div className="relative" ref={typeDropdownRef}>
                    <button
                      ...
                      className="w-full px-4 py-4 bg-[#F7F8FA] rounded-lg flex justify-between items-center text-[#050F1C] text-sm font-normal"
                    >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-4 bg-[#F7F8FA] rounded-lg text-[#050F1C] text-sm font-normal outline-none focus:ring-2 focus:ring-[#022658] resize-none min-h-[80px]"
