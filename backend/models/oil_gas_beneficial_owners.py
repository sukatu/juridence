...
class OilGasBeneficialOwner(Base):
    __tablename__ = "oil_gas_beneficial_owners"
    ...
    # Relationships
    oil_gas_company = relationship("OilGasCompanies", back_populates="oil_gas_beneficial_owners")
