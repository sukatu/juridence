...
class OilGasCapitalDetail(Base):
    __tablename__ = "oil_gas_capital_details"
    ...
    # Relationships
    oil_gas_company = relationship("OilGasCompanies", back_populates="oil_gas_capital_details")
